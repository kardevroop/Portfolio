export const navItems = [
  ...
  export const gridItems = [
    ...
    {
      id: 5,
      title: "Currently building a Multi-Armed bandit framework",
  ...
  export const projects = [
    ...
    //   img: "/images/p4.svg",
    //   iconLists: ["/images/next.svg", "/images/tail.svg", "/images/ts.svg", "/images/three.svg", "/images/gsap.svg"],
    ...
    // },
    {
      ...
      des: "Recreated the functionalities of the Twitter platform using ReactJS to design the site and MongoDb to store data.",
      img: "/images/p4.svg",
      iconLists: ["/images/next.svg", "/images/tail.svg", "/images/ts.svg", "/images/three.svg", "/images/gsap.svg"],
      link: "https://github.com/kardevroop/CS5500-Node-Server",
    },
  ];
  ...
  export const publications = [
    ...
    },
    {
      ...
      link: "https://doi.org/10.1109/ANTS47819.2019.9118073",
    },
  ...
  export const workExperience = [
    ...
    {
      id: 1,
      title: "Graduate Research Assisstant @ RIT",
      desc: "Working on RL and multi-armed bandit models to drive decision-making in real-time tasks.",
      className: "md:col-span-2",
      thumbnail: "/images/exp2.svg",
    },
    {
      id: 2,
      title: "Graduate Teaching Assisstant @ Northeastern",
      desc: "Assisted in mentoring students about SQL and No-SQL databases.",
      className: "md:col-span-2",
      thumbnail: "/images/exp3.svg",
    },
    {
      id: 3,
      title: "Data Engineer @ PwC",
      desc: "Designing and Developing Azure ETL pipelines and SQL solutions to support business reporting needs.",
      className: "md:col-span-2",
      thumbnail: "/images/exp1.svg",
    },
  ];
